...
const Dashboard = () => {
  ...
  useEffect(() => {
    if (location.state?.showLoginToast) {
      const name = location.state.userName || displayName;
      showSuccessToast(
        "Welcome back!",
        `Hi ${name}, you have signed in successfully.`
      );
      navigate(location.pathname, { replace: true, state: {} });
    }
  }, [location.state, location.pathname, displayName, navigate]);
    ...
    <div>
      <div className="page-wrapper">
        <div className="content">
          <div className="welcome d-lg-flex align-items-center justify-content-between mb-4">
